...
Requires the model to support xref:optapy-configuration/optapy-configuration.adoc#planningValueStrength[planning value strength comparison].
...
Requires the model to support xref:optapy-configuration/optapy-configuration.adoc#planningEntityDifficulty[planning entity difficulty comparison]
and xref:optapy-configuration/optapy-configuration.adoc#planningValueStrength[planning value strength comparison].
