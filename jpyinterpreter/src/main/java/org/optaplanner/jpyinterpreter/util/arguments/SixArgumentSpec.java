...
public class SixArgumentSpec<Out_, Arg1_, Arg2_, Arg3_, Arg4_, Arg5_, Arg6_>
        extends
        ArgumentSpec<Out_, SevenArgumentSpec<Out_, Arg1_, Arg2_, Arg3_, Arg4_, Arg5_, Arg6_, ?>, HexaFunction<Arg1_, Arg2_, Arg3_, Arg4_, Arg5_, Arg6_, Out_>> {

    protected SixArgumentSpec(String argumentName, Class<?> argumentType, ArgumentKind argumentKind, Arg6_ defaultValue,
    ...
    protected <ArgumentType_ extends PythonLikeObject>
            SevenArgumentSpec<Out_, Arg1_, Arg2_, Arg3_, Arg4_, Arg5_, Arg6_, ArgumentType_> addArgument(
                    String argumentName, Class<ArgumentType_> argumentType, ArgumentKind argumentKind,
                    ArgumentType_ defaultValue,
                    Optional<Integer> extraPositionalsArgumentIndex, Optional<Integer> extraKeywordsArgumentIndex) {
        return new SevenArgumentSpec<>(argumentName, argumentType, argumentKind, defaultValue,
                extraPositionalsArgumentIndex, extraKeywordsArgumentIndex, this);
    }

    @Override
    public <ArgumentType_ extends PythonLikeObject>
            SevenArgumentSpec<Out_, Arg1_, Arg2_, Arg3_, Arg4_, Arg5_, Arg6_, ArgumentType_>
    ...
    @Override
    public SevenArgumentSpec<Out_, Arg1_, Arg2_, Arg3_, Arg4_, Arg5_, Arg6_, PythonLikeTuple>
    ...
    @Override
    public SevenArgumentSpec<Out_, Arg1_, Arg2_, Arg3_, Arg4_, Arg5_, Arg6_, PythonLikeDict>
    ...
    public Out_ apply(List<PythonLikeObject> positionalArgumentList,
            ...
            HexaFunction<Arg1_, Arg2_, Arg3_, Arg4_, Arg5_, Arg6_, Out_> extractor) {
