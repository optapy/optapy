...
public class ThirteenArgumentSpec<Out_, Arg1_, Arg2_, Arg3_, Arg4_, Arg5_, Arg6_, Arg7_, Arg8_, Arg9_, Arg10_, Arg11_, Arg12_, Arg13_>
        extends
        ArgumentSpec<Out_, FourteenArgumentSpec<Out_, Arg1_, Arg2_, Arg3_, Arg4_, Arg5_, Arg6_, Arg7_, Arg8_, Arg9_, Arg10_, Arg11_, Arg12_, Arg13_, ?>, ThirteenArgFunction<Arg1_, Arg2_, Arg3_, Arg4_, Arg5_, Arg6_, Arg7_, Arg8_, Arg9_, Arg10_, Arg11_, Arg12_, Arg13_, Out_>> {

    protected ThirteenArgumentSpec(String argumentName, Class<?> argumentType, ArgumentKind argumentKind, Arg13_ defaultValue,
    ...
    protected <ArgumentType_ extends PythonLikeObject>
            FourteenArgumentSpec<Out_, Arg1_, Arg2_, Arg3_, Arg4_, Arg5_, Arg6_, Arg7_, Arg8_, Arg9_, Arg10_, Arg11_, Arg12_, Arg13_, ArgumentType_>
            addArgument(
                    String argumentName, Class<ArgumentType_> argumentType, ArgumentKind argumentKind,
                    ArgumentType_ defaultValue,
                    Optional<Integer> extraPositionalsArgumentIndex, Optional<Integer> extraKeywordsArgumentIndex) {
        return new FourteenArgumentSpec<>(argumentName, argumentType, argumentKind, defaultValue,
    ...
    @Override
    public
            FourteenArgumentSpec<Out_, Arg1_, Arg2_, Arg3_, Arg4_, Arg5_, Arg6_, Arg7_, Arg8_, Arg9_, Arg10_, Arg11_, Arg12_, Arg13_, PythonLikeTuple>
    ...
    @Override
    public
            FourteenArgumentSpec<Out_, Arg1_, Arg2_, Arg3_, Arg4_, Arg5_, Arg6_, Arg7_, Arg8_, Arg9_, Arg10_, Arg11_, Arg12_, Arg13_, PythonLikeDict>
    ...
    public Out_ apply(List<PythonLikeObject> positionalArgumentList,
            ...
            ThirteenArgFunction<Arg1_, Arg2_, Arg3_, Arg4_, Arg5_, Arg6_, Arg7_, Arg8_, Arg9_, Arg10_, Arg11_, Arg12_, Arg13_, Out_> extractor) {
