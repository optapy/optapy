...
public class FourteenArgumentSpec<Out_, Arg1_, Arg2_, Arg3_, Arg4_, Arg5_, Arg6_, Arg7_, Arg8_, Arg9_, Arg10_, Arg11_, Arg12_, Arg13_, Arg14_>
        extends
        ArgumentSpec<Out_, FifteenArgumentSpec<Out_, Arg1_, Arg2_, Arg3_, Arg4_, Arg5_, Arg6_, Arg7_, Arg8_, Arg9_, Arg10_, Arg11_, Arg12_, Arg13_, Arg14_, ?>, FourteenArgFunction<Arg1_, Arg2_, Arg3_, Arg4_, Arg5_, Arg6_, Arg7_, Arg8_, Arg9_, Arg10_, Arg11_, Arg12_, Arg13_, Arg14_, Out_>> {

    protected FourteenArgumentSpec(String argumentName, Class<?> argumentType, ArgumentKind argumentKind, Arg14_ defaultValue,
    ...
    protected <ArgumentType_ extends PythonLikeObject>
            FifteenArgumentSpec<Out_, Arg1_, Arg2_, Arg3_, Arg4_, Arg5_, Arg6_, Arg7_, Arg8_, Arg9_, Arg10_, Arg11_, Arg12_, Arg13_, Arg14_, ArgumentType_>
            addArgument(
                    String argumentName, Class<ArgumentType_> argumentType, ArgumentKind argumentKind,
                    ArgumentType_ defaultValue,
                    Optional<Integer> extraPositionalsArgumentIndex, Optional<Integer> extraKeywordsArgumentIndex) {
        return new FifteenArgumentSpec<>(argumentName, argumentType, argumentKind, defaultValue,
    ...
    @Override
    public
            FifteenArgumentSpec<Out_, Arg1_, Arg2_, Arg3_, Arg4_, Arg5_, Arg6_, Arg7_, Arg8_, Arg9_, Arg10_, Arg11_, Arg12_, Arg13_, Arg14_, PythonLikeTuple>
    ...
    @Override
    public
            FifteenArgumentSpec<Out_, Arg1_, Arg2_, Arg3_, Arg4_, Arg5_, Arg6_, Arg7_, Arg8_, Arg9_, Arg10_, Arg11_, Arg12_, Arg13_, Arg14_, PythonLikeDict>
    ...
    public Out_ apply(List<PythonLikeObject> positionalArgumentList,
            ...
            FourteenArgFunction<Arg1_, Arg2_, Arg3_, Arg4_, Arg5_, Arg6_, Arg7_, Arg8_, Arg9_, Arg10_, Arg11_, Arg12_, Arg13_, Arg14_, Out_> extractor) {
