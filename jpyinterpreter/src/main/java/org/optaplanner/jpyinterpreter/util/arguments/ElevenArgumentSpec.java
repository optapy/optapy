...
public class ElevenArgumentSpec<Out_, Arg1_, Arg2_, Arg3_, Arg4_, Arg5_, Arg6_, Arg7_, Arg8_, Arg9_, Arg10_, Arg11_>
        extends
        ArgumentSpec<Out_, TwelveArgumentSpec<Out_, Arg1_, Arg2_, Arg3_, Arg4_, Arg5_, Arg6_, Arg7_, Arg8_, Arg9_, Arg10_, Arg11_, ?>, ElevenArgFunction<Arg1_, Arg2_, Arg3_, Arg4_, Arg5_, Arg6_, Arg7_, Arg8_, Arg9_, Arg10_, Arg11_, Out_>> {

    protected ElevenArgumentSpec(String argumentName, Class<?> argumentType, ArgumentKind argumentKind, Arg11_ defaultValue,
    ...
    protected <ArgumentType_ extends PythonLikeObject>
            TwelveArgumentSpec<Out_, Arg1_, Arg2_, Arg3_, Arg4_, Arg5_, Arg6_, Arg7_, Arg8_, Arg9_, Arg10_, Arg11_, ArgumentType_>
            addArgument(
                    String argumentName, Class<ArgumentType_> argumentType, ArgumentKind argumentKind,
                    ArgumentType_ defaultValue,
                    Optional<Integer> extraPositionalsArgumentIndex, Optional<Integer> extraKeywordsArgumentIndex) {
        return new TwelveArgumentSpec<>(argumentName, argumentType, argumentKind, defaultValue,
    ...
    @Override
    public
            TwelveArgumentSpec<Out_, Arg1_, Arg2_, Arg3_, Arg4_, Arg5_, Arg6_, Arg7_, Arg8_, Arg9_, Arg10_, Arg11_, PythonLikeTuple>
    ...
    @Override
    public
            TwelveArgumentSpec<Out_, Arg1_, Arg2_, Arg3_, Arg4_, Arg5_, Arg6_, Arg7_, Arg8_, Arg9_, Arg10_, Arg11_, PythonLikeDict>
    ...
    public Out_ apply(List<PythonLikeObject> positionalArgumentList,
            ...
            ElevenArgFunction<Arg1_, Arg2_, Arg3_, Arg4_, Arg5_, Arg6_, Arg7_, Arg8_, Arg9_, Arg10_, Arg11_, Out_> extractor) {
