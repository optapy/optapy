...
public class EightArgumentSpec<Out_, Arg1_, Arg2_, Arg3_, Arg4_, Arg5_, Arg6_, Arg7_, Arg8_>
        extends
        ArgumentSpec<Out_, NineArgumentSpec<Out_, Arg1_, Arg2_, Arg3_, Arg4_, Arg5_, Arg6_, Arg7_, Arg8_, ?>, EightArgFunction<Arg1_, Arg2_, Arg3_, Arg4_, Arg5_, Arg6_, Arg7_, Arg8_, Out_>> {

    protected EightArgumentSpec(String argumentName, Class<?> argumentType, ArgumentKind argumentKind, Arg8_ defaultValue,
    ...
    protected <ArgumentType_ extends PythonLikeObject>
            NineArgumentSpec<Out_, Arg1_, Arg2_, Arg3_, Arg4_, Arg5_, Arg6_, Arg7_, Arg8_, ArgumentType_> addArgument(
                    String argumentName, Class<ArgumentType_> argumentType, ArgumentKind argumentKind,
                    ArgumentType_ defaultValue,
                    Optional<Integer> extraPositionalsArgumentIndex, Optional<Integer> extraKeywordsArgumentIndex) {
        return new NineArgumentSpec<>(argumentName, argumentType, argumentKind, defaultValue,
                extraPositionalsArgumentIndex, extraKeywordsArgumentIndex, this);
    }

    @Override
    public <ArgumentType_ extends PythonLikeObject>
            NineArgumentSpec<Out_, Arg1_, Arg2_, Arg3_, Arg4_, Arg5_, Arg6_, Arg7_, Arg8_, ArgumentType_>
    ...
    @Override
    public
            NineArgumentSpec<Out_, Arg1_, Arg2_, Arg3_, Arg4_, Arg5_, Arg6_, Arg7_, Arg8_, PythonLikeTuple>
    ...
    @Override
    public
            NineArgumentSpec<Out_, Arg1_, Arg2_, Arg3_, Arg4_, Arg5_, Arg6_, Arg7_, Arg8_, PythonLikeDict>
    ...
    public Out_ apply(List<PythonLikeObject> positionalArgumentList,
            ...
            EightArgFunction<Arg1_, Arg2_, Arg3_, Arg4_, Arg5_, Arg6_, Arg7_, Arg8_, Out_> extractor) {
