...
public class FifteenArgumentSpec<Out_, Arg1_, Arg2_, Arg3_, Arg4_, Arg5_, Arg6_, Arg7_, Arg8_, Arg9_, Arg10_, Arg11_, Arg12_, Arg13_, Arg14_, Arg15_>
        extends
        ArgumentSpec<Out_, SixteenArgumentSpec<Out_, Arg1_, Arg2_, Arg3_, Arg4_, Arg5_, Arg6_, Arg7_, Arg8_, Arg9_, Arg10_, Arg11_, Arg12_, Arg13_, Arg14_, Arg15_, ?>, FifteenArgFunction<Arg1_, Arg2_, Arg3_, Arg4_, Arg5_, Arg6_, Arg7_, Arg8_, Arg9_, Arg10_, Arg11_, Arg12_, Arg13_, Arg14_, Arg15_, Out_>> {

    protected FifteenArgumentSpec(String argumentName, Class<?> argumentType, ArgumentKind argumentKind, Arg15_ defaultValue,
    ...
    protected <ArgumentType_ extends PythonLikeObject>
            SixteenArgumentSpec<Out_, Arg1_, Arg2_, Arg3_, Arg4_, Arg5_, Arg6_, Arg7_, Arg8_, Arg9_, Arg10_, Arg11_, Arg12_, Arg13_, Arg14_, Arg15_, ArgumentType_>
            addArgument(
                    String argumentName, Class<ArgumentType_> argumentType, ArgumentKind argumentKind,
                    ArgumentType_ defaultValue,
                    Optional<Integer> extraPositionalsArgumentIndex, Optional<Integer> extraKeywordsArgumentIndex) {
        return new SixteenArgumentSpec<>(argumentName, argumentType, argumentKind, defaultValue,
    ...
    @Override
    public
            SixteenArgumentSpec<Out_, Arg1_, Arg2_, Arg3_, Arg4_, Arg5_, Arg6_, Arg7_, Arg8_, Arg9_, Arg10_, Arg11_, Arg12_, Arg13_, Arg14_, Arg15_, PythonLikeTuple>
    ...
    @Override
    public
            SixteenArgumentSpec<Out_, Arg1_, Arg2_, Arg3_, Arg4_, Arg5_, Arg6_, Arg7_, Arg8_, Arg9_, Arg10_, Arg11_, Arg12_, Arg13_, Arg14_, Arg15_, PythonLikeDict>
    ...
    public Out_ apply(List<PythonLikeObject> positionalArgumentList,
            ...
            FifteenArgFunction<Arg1_, Arg2_, Arg3_, Arg4_, Arg5_, Arg6_, Arg7_, Arg8_, Arg9_, Arg10_, Arg11_, Arg12_, Arg13_, Arg14_, Arg15_, Out_> extractor) {
