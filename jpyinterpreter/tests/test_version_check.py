...
def test_version_check():
    ...
    assert is_python_version_supported((3, 9, 0, 'Final', 0)) is True
    assert is_python_version_supported((3, 9, 1, 'Final', 0)) is True
    ...
    assert is_python_version_supported((3, 12, 0, 'Final', 0)) is False
    assert is_python_version_supported((3, 12, 3, 'Final', 0)) is False
