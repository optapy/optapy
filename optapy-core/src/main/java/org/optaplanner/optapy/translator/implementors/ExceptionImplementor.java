...
import org.optaplanner.optapy.translator.types.errors.PythonBaseException;
...
public class ExceptionImplementor {
    ...
    public static void createTryFinallyBlock(MethodVisitor methodVisitor, String className,
        ...
        Label finallyStart = bytecodeCounterToLabelMap.computeIfAbsent(instruction.offset + instruction.arg, key -> new Label());
