...
import static org.optaplanner.python.translator.types.PythonBytes.BYTE_TO_INT;
...
import org.optaplanner.python.translator.util.ByteCharSequence;
...
public class PythonByteArray extends AbstractPythonLikeObject implements PythonBytesLikeObject {
    ...
    private static PythonLikeType registerMethods() throws NoSuchMethodException {
        ...
        // Other
        BYTE_ARRAY_TYPE.addMethod("append", PythonByteArray.class.getMethod("appendByte", PythonInteger.class));
        BYTE_ARRAY_TYPE.addMethod("clear", PythonByteArray.class.getMethod("clear"));
        BYTE_ARRAY_TYPE.addMethod("copy", PythonByteArray.class.getMethod("copy"));
        BYTE_ARRAY_TYPE.addMethod("extend", PythonByteArray.class.getMethod("extend", PythonLikeObject.class));
        BYTE_ARRAY_TYPE.addMethod("insert",
                PythonByteArray.class.getMethod("insert", PythonInteger.class, PythonInteger.class));
        BYTE_ARRAY_TYPE.addMethod("pop", PythonByteArray.class.getMethod("pop"));
        BYTE_ARRAY_TYPE.addMethod("pop", PythonByteArray.class.getMethod("pop", PythonInteger.class));
        BYTE_ARRAY_TYPE.addMethod("remove", PythonByteArray.class.getMethod("remove", PythonInteger.class));
        BYTE_ARRAY_TYPE.addMethod("reverse", PythonByteArray.class.getMethod("reverse"));

        BYTE_ARRAY_TYPE.addMethod("capitalize", PythonByteArray.class.getMethod("capitalize"));

        BYTE_ARRAY_TYPE.addMethod("center", PythonByteArray.class.getMethod("center", PythonInteger.class));
        BYTE_ARRAY_TYPE.addMethod("center",
                PythonByteArray.class.getMethod("center", PythonInteger.class, PythonByteArray.class));

        BYTE_ARRAY_TYPE.addMethod("count", PythonByteArray.class.getMethod("count", PythonInteger.class));
        BYTE_ARRAY_TYPE.addMethod("count", PythonByteArray.class.getMethod("count", PythonInteger.class, PythonInteger.class));
        BYTE_ARRAY_TYPE.addMethod("count",
                PythonByteArray.class.getMethod("count", PythonInteger.class, PythonInteger.class, PythonInteger.class));

        BYTE_ARRAY_TYPE.addMethod("count", PythonByteArray.class.getMethod("count", PythonByteArray.class));
        BYTE_ARRAY_TYPE.addMethod("count",
        ...
        BYTE_ARRAY_TYPE.addMethod("endswith", PythonByteArray.class.getMethod("endsWith", PythonByteArray.class));
        BYTE_ARRAY_TYPE.addMethod("endswith", PythonByteArray.class.getMethod("endsWith", PythonLikeTuple.class));
        BYTE_ARRAY_TYPE.addMethod("endswith",
        ...
        BYTE_ARRAY_TYPE.addMethod("expandtabs", PythonByteArray.class.getMethod("expandTabs"));
        BYTE_ARRAY_TYPE.addMethod("expandtabs", PythonByteArray.class.getMethod("expandTabs", PythonInteger.class));

        BYTE_ARRAY_TYPE.addMethod("find", PythonByteArray.class.getMethod("find", PythonByteArray.class));
        BYTE_ARRAY_TYPE.addMethod("find", PythonByteArray.class.getMethod("find", PythonInteger.class));
        BYTE_ARRAY_TYPE.addMethod("find", PythonByteArray.class.getMethod("find", PythonByteArray.class, PythonInteger.class));
        BYTE_ARRAY_TYPE.addMethod("find", PythonByteArray.class.getMethod("find", PythonInteger.class, PythonInteger.class));
        BYTE_ARRAY_TYPE.addMethod("find",
        ...
        BYTE_ARRAY_TYPE.addMethod("index", PythonByteArray.class.getMethod("index", PythonByteArray.class));
        BYTE_ARRAY_TYPE.addMethod("index", PythonByteArray.class.getMethod("index", PythonInteger.class));
        BYTE_ARRAY_TYPE.addMethod("index",
                PythonByteArray.class.getMethod("index", PythonByteArray.class, PythonInteger.class));
        BYTE_ARRAY_TYPE.addMethod("index", PythonByteArray.class.getMethod("index", PythonInteger.class, PythonInteger.class));
        BYTE_ARRAY_TYPE.addMethod("index",
        ...
        BYTE_ARRAY_TYPE.addMethod("isalnum", PythonByteArray.class.getMethod("isAlphaNumeric"));
        BYTE_ARRAY_TYPE.addMethod("isalpha", PythonByteArray.class.getMethod("isAlpha"));
        BYTE_ARRAY_TYPE.addMethod("isascii", PythonByteArray.class.getMethod("isAscii"));
        BYTE_ARRAY_TYPE.addMethod("isdigit", PythonByteArray.class.getMethod("isDigit"));
        BYTE_ARRAY_TYPE.addMethod("islower", PythonByteArray.class.getMethod("isLower"));
        BYTE_ARRAY_TYPE.addMethod("isspace", PythonByteArray.class.getMethod("isSpace"));
        BYTE_ARRAY_TYPE.addMethod("istitle", PythonByteArray.class.getMethod("isTitle"));
        BYTE_ARRAY_TYPE.addMethod("isupper", PythonByteArray.class.getMethod("isUpper"));

        BYTE_ARRAY_TYPE.addMethod("join", PythonByteArray.class.getMethod("join", PythonLikeObject.class));

        BYTE_ARRAY_TYPE.addMethod("ljust", PythonByteArray.class.getMethod("leftJustify", PythonInteger.class));
        BYTE_ARRAY_TYPE.addMethod("ljust",
                PythonByteArray.class.getMethod("leftJustify", PythonInteger.class, PythonByteArray.class));

        BYTE_ARRAY_TYPE.addMethod("lower", PythonByteArray.class.getMethod("lower"));

        BYTE_ARRAY_TYPE.addMethod("lstrip", PythonByteArray.class.getMethod("leftStrip"));
        BYTE_ARRAY_TYPE.addMethod("lstrip", PythonByteArray.class.getMethod("leftStrip", PythonNone.class));
        BYTE_ARRAY_TYPE.addMethod("lstrip", PythonByteArray.class.getMethod("leftStrip", PythonByteArray.class));

        // TODO: maketrans

        BYTE_ARRAY_TYPE.addMethod("partition", PythonByteArray.class.getMethod("partition", PythonByteArray.class));

        BYTE_ARRAY_TYPE.addMethod("removeprefix", PythonByteArray.class.getMethod("removePrefix", PythonByteArray.class));

        BYTE_ARRAY_TYPE.addMethod("removesuffix", PythonByteArray.class.getMethod("removeSuffix", PythonByteArray.class));

        BYTE_ARRAY_TYPE.addMethod("replace",
        ...
        BYTE_ARRAY_TYPE.addMethod("rfind", PythonByteArray.class.getMethod("rightFind", PythonByteArray.class));
        BYTE_ARRAY_TYPE.addMethod("rfind", PythonByteArray.class.getMethod("rightFind", PythonInteger.class));
        BYTE_ARRAY_TYPE.addMethod("rfind",
        ...
        BYTE_ARRAY_TYPE.addMethod("rindex", PythonByteArray.class.getMethod("rightIndex", PythonByteArray.class));
        BYTE_ARRAY_TYPE.addMethod("rindex", PythonByteArray.class.getMethod("rightIndex", PythonInteger.class));
        BYTE_ARRAY_TYPE.addMethod("rindex",
        ...
        BYTE_ARRAY_TYPE.addMethod("rjust", PythonByteArray.class.getMethod("rightJustify", PythonInteger.class));
        BYTE_ARRAY_TYPE.addMethod("rjust",
                PythonByteArray.class.getMethod("rightJustify", PythonInteger.class, PythonByteArray.class));

        BYTE_ARRAY_TYPE.addMethod("rpartition", PythonByteArray.class.getMethod("rightPartition", PythonByteArray.class));

        BYTE_ARRAY_TYPE.addMethod("rsplit", PythonByteArray.class.getMethod("rightSplit"));
        BYTE_ARRAY_TYPE.addMethod("rsplit", PythonByteArray.class.getMethod("rightSplit", PythonNone.class));
        BYTE_ARRAY_TYPE.addMethod("rsplit", PythonByteArray.class.getMethod("rightSplit", PythonByteArray.class));
        BYTE_ARRAY_TYPE.addMethod("rsplit",
        ...
        BYTE_ARRAY_TYPE.addMethod("rstrip", PythonByteArray.class.getMethod("rightStrip"));
        BYTE_ARRAY_TYPE.addMethod("rstrip", PythonByteArray.class.getMethod("rightStrip", PythonNone.class));
        BYTE_ARRAY_TYPE.addMethod("rstrip", PythonByteArray.class.getMethod("rightStrip", PythonByteArray.class));

        BYTE_ARRAY_TYPE.addMethod("split", PythonByteArray.class.getMethod("split"));
        BYTE_ARRAY_TYPE.addMethod("split", PythonByteArray.class.getMethod("split", PythonNone.class));
        BYTE_ARRAY_TYPE.addMethod("split", PythonByteArray.class.getMethod("split", PythonByteArray.class));
        BYTE_ARRAY_TYPE.addMethod("split", PythonByteArray.class.getMethod("split", PythonNone.class, PythonInteger.class));
        BYTE_ARRAY_TYPE.addMethod("split",
                PythonByteArray.class.getMethod("split", PythonByteArray.class, PythonInteger.class));

        BYTE_ARRAY_TYPE.addMethod("splitlines", PythonByteArray.class.getMethod("splitLines"));
        BYTE_ARRAY_TYPE.addMethod("splitlines", PythonByteArray.class.getMethod("splitLines", PythonBoolean.class));

        BYTE_ARRAY_TYPE.addMethod("startswith", PythonByteArray.class.getMethod("startsWith", PythonByteArray.class));
        BYTE_ARRAY_TYPE.addMethod("startswith", PythonByteArray.class.getMethod("startsWith", PythonLikeTuple.class));
        BYTE_ARRAY_TYPE.addMethod("startswith",
        ...
        BYTE_ARRAY_TYPE.addMethod("strip", PythonByteArray.class.getMethod("strip"));
        BYTE_ARRAY_TYPE.addMethod("strip", PythonByteArray.class.getMethod("strip", PythonNone.class));
        BYTE_ARRAY_TYPE.addMethod("strip", PythonByteArray.class.getMethod("strip", PythonByteArray.class));

        BYTE_ARRAY_TYPE.addMethod("swapcase", PythonByteArray.class.getMethod("swapCase"));

        BYTE_ARRAY_TYPE.addMethod("title", PythonByteArray.class.getMethod("title"));

        BYTE_ARRAY_TYPE.addMethod("translate", PythonByteArray.class.getMethod("translate", PythonBytes.class));
        BYTE_ARRAY_TYPE.addMethod("translate", PythonByteArray.class.getMethod("translate", PythonByteArray.class));

        BYTE_ARRAY_TYPE.addMethod("upper", PythonByteArray.class.getMethod("upper"));

        BYTE_ARRAY_TYPE.addMethod("zfill", PythonByteArray.class.getMethod("zfill", PythonInteger.class));
    ...
    public final PythonLikeTuple asIntTuple() {
        return IntStream.range(0, valueBuffer.limit()).mapToObj(index -> BYTE_TO_INT[valueBuffer.get(index) & 0xFF])
    ...
    public PythonInteger getCharAt(PythonInteger position) {
        ...
        return BYTE_TO_INT[valueBuffer.get(index) & 0xFF];
    }
    ...
    public PythonIterator<PythonInteger> getIterator() {
        return new PythonIterator<>(IntStream.range(0, valueBuffer.limit())
                .mapToObj(index -> BYTE_TO_INT[valueBuffer.get(index)])
                .iterator());
    }
