...
public class PythonBytes extends AbstractPythonLikeObject implements PythonBytesLikeObject {
    ...
    private static PythonLikeType registerMethods() throws NoSuchMethodException {
        ...
        BYTES_TYPE.addMethod("center", PythonBytes.class.getMethod("center", PythonInteger.class));
        BYTES_TYPE.addMethod("center", PythonBytes.class.getMethod("center", PythonInteger.class, PythonBytes.class));

        BYTES_TYPE.addMethod("count", PythonBytes.class.getMethod("count", PythonInteger.class));
        BYTES_TYPE.addMethod("count", PythonBytes.class.getMethod("count", PythonInteger.class, PythonInteger.class));
        BYTES_TYPE.addMethod("count",
                PythonBytes.class.getMethod("count", PythonInteger.class, PythonInteger.class, PythonInteger.class));

        BYTES_TYPE.addMethod("count", PythonBytes.class.getMethod("count", PythonBytes.class));
        BYTES_TYPE.addMethod("count", PythonBytes.class.getMethod("count", PythonBytes.class, PythonInteger.class));
        BYTES_TYPE.addMethod("count",
                PythonBytes.class.getMethod("count", PythonBytes.class, PythonInteger.class, PythonInteger.class));

        // TODO: decode

        BYTES_TYPE.addMethod("endswith", PythonBytes.class.getMethod("endsWith", PythonBytes.class));
        BYTES_TYPE.addMethod("endswith", PythonBytes.class.getMethod("endsWith", PythonLikeTuple.class));
        BYTES_TYPE.addMethod("endswith", PythonBytes.class.getMethod("endsWith", PythonBytes.class, PythonInteger.class));
        BYTES_TYPE.addMethod("endswith", PythonBytes.class.getMethod("endsWith", PythonLikeTuple.class, PythonInteger.class));
        BYTES_TYPE.addMethod("endswith",
        ...
        BYTES_TYPE.addMethod("expandtabs", PythonBytes.class.getMethod("expandTabs"));
        BYTES_TYPE.addMethod("expandtabs", PythonBytes.class.getMethod("expandTabs", PythonInteger.class));

        BYTES_TYPE.addMethod("find", PythonBytes.class.getMethod("find", PythonBytes.class));
        BYTES_TYPE.addMethod("find", PythonBytes.class.getMethod("find", PythonInteger.class));
        BYTES_TYPE.addMethod("find", PythonBytes.class.getMethod("find", PythonBytes.class, PythonInteger.class));
        BYTES_TYPE.addMethod("find", PythonBytes.class.getMethod("find", PythonInteger.class, PythonInteger.class));
        BYTES_TYPE.addMethod("find",
        ...
        BYTES_TYPE.addMethod("index", PythonBytes.class.getMethod("index", PythonBytes.class));
        BYTES_TYPE.addMethod("index", PythonBytes.class.getMethod("index", PythonInteger.class));
        BYTES_TYPE.addMethod("index", PythonBytes.class.getMethod("index", PythonBytes.class, PythonInteger.class));
        BYTES_TYPE.addMethod("index", PythonBytes.class.getMethod("index", PythonInteger.class, PythonInteger.class));
        BYTES_TYPE.addMethod("index",
        ...
        BYTES_TYPE.addMethod("isalnum", PythonBytes.class.getMethod("isAlphaNumeric"));
        BYTES_TYPE.addMethod("isalpha", PythonBytes.class.getMethod("isAlpha"));
        BYTES_TYPE.addMethod("isascii", PythonBytes.class.getMethod("isAscii"));
        BYTES_TYPE.addMethod("isdigit", PythonBytes.class.getMethod("isDigit"));
        BYTES_TYPE.addMethod("islower", PythonBytes.class.getMethod("isLower"));
        BYTES_TYPE.addMethod("isspace", PythonBytes.class.getMethod("isSpace"));
        BYTES_TYPE.addMethod("istitle", PythonBytes.class.getMethod("isTitle"));
        BYTES_TYPE.addMethod("isupper", PythonBytes.class.getMethod("isUpper"));

        BYTES_TYPE.addMethod("join", PythonBytes.class.getMethod("join", PythonLikeObject.class));

        BYTES_TYPE.addMethod("ljust", PythonBytes.class.getMethod("leftJustify", PythonInteger.class));
        BYTES_TYPE.addMethod("ljust", PythonBytes.class.getMethod("leftJustify", PythonInteger.class, PythonBytes.class));

        BYTES_TYPE.addMethod("lower", PythonBytes.class.getMethod("lower"));

        BYTES_TYPE.addMethod("lstrip", PythonBytes.class.getMethod("leftStrip"));
        BYTES_TYPE.addMethod("lstrip", PythonBytes.class.getMethod("leftStrip", PythonNone.class));
        BYTES_TYPE.addMethod("lstrip", PythonBytes.class.getMethod("leftStrip", PythonBytes.class));

        // TODO: maketrans

        BYTES_TYPE.addMethod("partition", PythonBytes.class.getMethod("partition", PythonBytes.class));

        BYTES_TYPE.addMethod("removeprefix", PythonBytes.class.getMethod("removePrefix", PythonBytes.class));

        BYTES_TYPE.addMethod("removesuffix", PythonBytes.class.getMethod("removeSuffix", PythonBytes.class));

        BYTES_TYPE.addMethod("replace", PythonBytes.class.getMethod("replace", PythonBytes.class, PythonBytes.class));
        BYTES_TYPE.addMethod("replace",
                PythonBytes.class.getMethod("replace", PythonBytes.class, PythonBytes.class, PythonInteger.class));

        BYTES_TYPE.addMethod("rfind", PythonBytes.class.getMethod("rightFind", PythonBytes.class));
        BYTES_TYPE.addMethod("rfind", PythonBytes.class.getMethod("rightFind", PythonInteger.class));
        BYTES_TYPE.addMethod("rfind", PythonBytes.class.getMethod("rightFind", PythonBytes.class, PythonInteger.class));
        BYTES_TYPE.addMethod("rfind", PythonBytes.class.getMethod("rightFind", PythonInteger.class, PythonInteger.class));
        BYTES_TYPE.addMethod("rfind",
        ...
        BYTES_TYPE.addMethod("rindex", PythonBytes.class.getMethod("rightIndex", PythonBytes.class));
        BYTES_TYPE.addMethod("rindex", PythonBytes.class.getMethod("rightIndex", PythonInteger.class));
        BYTES_TYPE.addMethod("rindex", PythonBytes.class.getMethod("rightIndex", PythonBytes.class, PythonInteger.class));
        BYTES_TYPE.addMethod("rindex", PythonBytes.class.getMethod("rightIndex", PythonInteger.class, PythonInteger.class));
        BYTES_TYPE.addMethod("rindex",
        ...
        BYTES_TYPE.addMethod("rjust", PythonBytes.class.getMethod("rightJustify", PythonInteger.class));
        BYTES_TYPE.addMethod("rjust", PythonBytes.class.getMethod("rightJustify", PythonInteger.class, PythonBytes.class));

        BYTES_TYPE.addMethod("rpartition", PythonBytes.class.getMethod("rightPartition", PythonBytes.class));

        BYTES_TYPE.addMethod("rsplit", PythonBytes.class.getMethod("rightSplit"));
        BYTES_TYPE.addMethod("rsplit", PythonBytes.class.getMethod("rightSplit", PythonNone.class));
        BYTES_TYPE.addMethod("rsplit", PythonBytes.class.getMethod("rightSplit", PythonBytes.class));
        BYTES_TYPE.addMethod("rsplit", PythonBytes.class.getMethod("rightSplit", PythonNone.class, PythonInteger.class));
        BYTES_TYPE.addMethod("rsplit", PythonBytes.class.getMethod("rightSplit", PythonBytes.class, PythonInteger.class));

        BYTES_TYPE.addMethod("rstrip", PythonBytes.class.getMethod("rightStrip"));
        BYTES_TYPE.addMethod("rstrip", PythonBytes.class.getMethod("rightStrip", PythonNone.class));
        BYTES_TYPE.addMethod("rstrip", PythonBytes.class.getMethod("rightStrip", PythonBytes.class));

        BYTES_TYPE.addMethod("split", PythonBytes.class.getMethod("split"));
        BYTES_TYPE.addMethod("split", PythonBytes.class.getMethod("split", PythonNone.class));
        BYTES_TYPE.addMethod("split", PythonBytes.class.getMethod("split", PythonBytes.class));
        BYTES_TYPE.addMethod("split", PythonBytes.class.getMethod("split", PythonNone.class, PythonInteger.class));
        BYTES_TYPE.addMethod("split", PythonBytes.class.getMethod("split", PythonBytes.class, PythonInteger.class));

        BYTES_TYPE.addMethod("splitlines", PythonBytes.class.getMethod("splitLines"));
        BYTES_TYPE.addMethod("splitlines", PythonBytes.class.getMethod("splitLines", PythonBoolean.class));

        BYTES_TYPE.addMethod("startswith", PythonBytes.class.getMethod("startsWith", PythonBytes.class));
        BYTES_TYPE.addMethod("startswith", PythonBytes.class.getMethod("startsWith", PythonLikeTuple.class));
        BYTES_TYPE.addMethod("startswith",
        ...
        BYTES_TYPE.addMethod("strip", PythonBytes.class.getMethod("strip"));
        BYTES_TYPE.addMethod("strip", PythonBytes.class.getMethod("strip", PythonNone.class));
        BYTES_TYPE.addMethod("strip", PythonBytes.class.getMethod("strip", PythonBytes.class));

        BYTES_TYPE.addMethod("swapcase", PythonBytes.class.getMethod("swapCase"));

        BYTES_TYPE.addMethod("title", PythonBytes.class.getMethod("title"));

        BYTES_TYPE.addMethod("translate", PythonBytes.class.getMethod("translate", PythonBytes.class));

        BYTES_TYPE.addMethod("upper", PythonBytes.class.getMethod("upper"));

        BYTES_TYPE.addMethod("zfill", PythonBytes.class.getMethod("zfill", PythonInteger.class));
